...
local Biters = require 'map_gen.towny.biters'
local Combat_balance = require 'map_gen.towny.combat_balance'
local Building = require 'map_gen.towny.building'
local Info = require 'map_gen.towny.info'
local Market = require 'map_gen.towny.market'
local Team = require 'map_gen.towny.team'
local Town_center = require 'map_gen.towny.town_center'
...
local function on_player_joined_game(event)
    ...
    if not global.towny.requests[player.index] then
        return
    end
    if global.towny.requests[player.index] ~= 'kill-character' then
        return
    end
