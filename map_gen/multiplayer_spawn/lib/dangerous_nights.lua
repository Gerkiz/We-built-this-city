...
require 'features.modules.splice_double'
require 'features.modules.spitters_spit_biters'
...
local function set_nighttime_modifiers(surface)
    ...
    game.print(raffle_messages[math_random(1, #raffle_messages)], {r = 150, g = 0, b = 0})
end
