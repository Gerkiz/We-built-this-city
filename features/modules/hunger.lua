...
function hunger_update(player, food_value)
    ...
    if player_hunger_buff[global.player_hunger[player.name]] < 0 then
        player_modifiers[player.index].character_running_speed_modifier['hunger'] =
            player_hunger_buff[global.player_hunger[player.name]] * 0.75
    else
        player_modifiers[player.index].character_running_speed_modifier['hunger'] =
            player_hunger_buff[global.player_hunger[player.name]] * 0.15
    end
