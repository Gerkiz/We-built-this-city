...
local rewards_loot = {
    [1] = {
        {name = 'submachine-gun', count = 1, text = ' Submachine Gun'},
        {name = 'firearm-magazine', count = 50, text = ' SMG Rounds'}
    },
    [2] = {
        {name = 'heavy-armor', count = 1, text = ' Heavy Armor'},
        {name = 'defender-capsule', count = 20, text = ' Defender-Bots'}
    },
    [3] = {
        {name = 'firearm-magazine', count = 50, text = ' SMG Rounds'},
        {name = 'grenade', count = 10, text = ' Grenades'}
    },
    [4] = {
        {name = 'land-mine', count = 20, text = ' Landmines'},
        {name = 'firearm-magazine', count = 100, text = ' SMG Rounds'}
    },
    [5] = {
        {name = 'slowdown-capsule', count = 20, text = ' Slowdown Capsules'},
        {name = 'poison-capsule', count = 20, text = ' Poison Capsules'}
    },
    [6] = {{name = 'land-mine', count = 30, text = ' Landmines'}, {name = 'raw-fish', count = 30, text = ' Fish Food'}},
    [7] = {
        {name = 'piercing-rounds-magazine', count = 50, text = ' SMG AP Rounds'},
        {name = 'distractor-capsule', count = 20, text = ' Distractor Capsules'}
    },
    [8] = {
        {name = 'combat-shotgun', count = 1, text = ' Combat Shotgun'},
        {name = 'piercing-shotgun-shell', count = 50, text = ' AP Shotgun Shells'}
    },
    [9] = {
        {name = 'poison-capsule', count = 40, text = ' Poison Capsule'},
        {name = 'piercing-rounds-magazine', count = 100, text = ' SMG AP Rounds'}
    },
    [10] = {
        {name = 'computer', count = 1, text = ' Teleporter Computer'},
        {name = 'modular-armor', count = 1, text = ' Modular Armor'}
    },
    [11] = {
    ...
    [12] = {
        ...
        {name = 'piercing-shotgun-shell', count = 100, text = ' AP Shotgun Shells'}
    },
    [13] = {
        {name = 'flamethrower', count = 1, text = ' Flamethrower'},
        {name = 'flamethrower-ammo', count = 50, text = ' Flamethrower Rounds'}
    },
    [14] = {
        {name = 'slowdown-capsule', count = 30, text = ' Slowdown Capsule'},
        {name = 'piercing-rounds-magazine', count = 200, text = ' SMG Rounds'}
    },
    [15] = {
        {name = 'battery-equipment', count = 2, text = ' MK1 Battery'},
        {name = 'solar-panel-equipment', count = 4, text = ' Portable Solar Panel'}
    },
    [16] = {
    ...
    [18] = {
        {name = 'exoskeleton-equipment', count = 1, text = ' Exoskelet'},
        {name = 'raw-fish', count = 50, text = ' Fish Food'}
    },
    [19] = {
    ...
    [20] = {
        {name = 'power-armor', count = 1, text = ' Power Armor MK1'},
        {name = 'computer', count = 1, text = ' Teleporter Computer'}
    },
    [21] = {
        {name = 'personal-roboport-equipment', count = 1, text = ' Armor Roboport MK1'},
        {name = 'construction-robot', count = 10, text = ' Construction-Bots'}
    },
    [22] = {
        {name = 'personal-laser-defense-equipment', count = 1, text = ' Personal Laser Defense'},
        {name = 'flamethrower-ammo', count = 100, text = ' Flamethrower Rounds'}
    },
    [23] = {
        {name = 'rocket', count = 40, text = ' Rockets'},
        {name = 'cluster-grenade', count = 20, text = ' Cluster-Grenades'}
    },
    [24] = {
        {name = 'explosive-rocket', count = 40, text = ' Explosive Rockets'},
        {name = 'piercing-rounds-magazine', count = 200, text = ' SMG Rounds'}
    },
    [25] = {
        {name = 'land-mine', count = 50, text = ' Landmines'},
    ...
    [27] = {
        {name = 'energy-shield-equipment', count = 2, text = ' Energy Shield MK1'},
        {name = 'poison-capsule', count = 50, text = ' Poison-Capsule'}
    },
    [28] = {
        {name = 'exoskeleton-equipment', count = 1, text = ' Exoskelet'},
        {name = 'battery-mk2-equipment', count = 1, text = ' Armor Battery Mk2'}
    ...
    [29] = {
        {name = 'distractor-capsule', count = 40, text = ' Distractor Bots'},
        {name = 'personal-laser-defense-equipment', count = 2, text = ' Personal Laser Defense'}
    },
    [30] = {
        {name = 'fusion-reactor-equipment', count = 1, text = ' Fusion Reactor'},
        {name = 'computer', count = 1, text = ' Teleporter Computer'}
    },
    [31] = {
        {name = 'uranium-rounds-magazine', count = 200, text = ' Uranium Rounds'},
        {name = 'destroyer-capsule', count = 40, text = ' Destroyer Capsules'}
    },
    [32] = {{name = 'destroyer-capsule', count = 50, text = ' Destroyer Bots'}},
    [33] = {{name = 'power-armor-mk2', count = 1, text = ' Power Armor MK2'}},
    [34] = {
        {name = 'exoskeleton-equipment', count = 1, text = ' Exoskeleton'},
        {name = 'uranium-rounds-magazine', count = 200, text = ' Uranium Rounds'}
    },
    ...
    [38] = {
        {name = 'fusion-reactor-equipment', count = 2, text = ' Fusion Reactor'},
        {name = 'uranium-rounds-magazine', count = 400, text = ' Uranium Rounds'}
    },
    [39] = {{name = 'atomic-bomb', count = 10, text = ' Atomic Rockets'}},
    [40] = {
        {name = 'computer', count = 2, text = ' Teleporter Computer'},
        {name = 'uranium-rounds-magazine', count = 500, text = ' Uranium Rounds'}
    }
}
...
local function reward_messages(data)
    ...
    local text_effect =
        player.surface.create_entity(
        {
            ...
            text = 'Reached Combat Level: ' .. data.next_level,
            color = {r = 0.2, g = 1.0, b = 0.1}
        }
    )
    ...
    for i = 1, #item_rewards, 1 do
        local text_effect =
            ...
            {
                name = 'flying-text',
                position = {player.position.x, player.position.y + (i * 0.5)},
                text = item_rewards[i].text,
    ...
    player.print(
        '[INFO] Kill Score Level ' .. data.next_level .. ' Achieved! Rewards: ' .. print_text,
        {r = 1.0, g = 0.84, b = 0.36}
    )
end
...
local function kill_rewards(event)
    ...
    if kill_score >= next_level_score then
        ...
        for k, item in pairs(rewards_loot[next_level]) do
            ...
            if (item.count - inserted_count) > 0 then
                ...
                surface.spill_item_stack(
                    center_position,
                    {name = item.name, count = (item.count - inserted_count)},
                    true
                )
        ...
        for i = 1, 5, 1 do
            ...
            local pos_list = {}
            area = {
                left_top = {x = (center_position.x - i), y = (center_position.y - i)},
                right_bottom = {x = (center_position.x + i + 1), y = (center_position.y + i + 1)}
            }
            for _, t in pairs(surface.find_tiles_filtered {area = area}) do
                local distance =
                    floor(sqrt((center_position.x - t.position.x) ^ 2 + (center_position.y - t.position.y) ^ 2))
                if (distance <= i) then
